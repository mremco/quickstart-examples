...
You are going to actually write some code there, so before you start please familiarize yourself with the [api documentation](https://tanker.io/docs/latest/api/tanker/?language=javascript).
